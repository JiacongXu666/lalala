...
if __name__ == '__main__':
    ...
    net = PIDNet_L(BasicBlock, [3, 3, 4, 4], num_classes=19, planes=64, spp_planes=128, head_planes=256, augment=False).cuda()
