...
def PIDNet_imagenet(cfg, pretrained=True):
    model = PIDNet_L(BasicBlock, [3, 3, 4, 4], num_classes=171, planes=64, spp_planes=112, head_planes=256, augment=True)
    if pretrained:
...
if __name__ == '__main__':
    ...
    model = PIDNet_L(BasicBlock, [3, 3, 4, 4], num_classes=171, planes=64, spp_planes=112, head_planes=256, augment=False)
    model.eval()
    model.to(device)
    iterations = None
