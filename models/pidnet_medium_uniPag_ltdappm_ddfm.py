...
class PIDNet_M(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=19, planes=64, spp_planes=128, head_planes=128, augment=False):
        ...
        self.spp = model_utils.Light_DAPPM(planes * 16, spp_planes, planes * 4)
...
def PIDNet_imagenet(cfg, pretrained=True):
    model = PIDNet_M(BasicBlock, [2, 2, 3, 3], num_classes=19, planes=64, spp_planes=112, head_planes=128, augment=True)
    if pretrained:
