...
def PIDNet_imagenet(cfg, pretrained=False):
    model = PIDNet_L(BasicBlock, [2, 2, 2, 2], num_classes=19, planes=32, spp_planes=128, head_planes=64, augment=True)
    if pretrained:
...
if __name__ == '__main__':
    ...
    net = PIDNet_L(BasicBlock, [2, 2, 3, 3], num_classes=19, planes=32, spp_planes=128, head_planes=64, augment=False).cuda()
